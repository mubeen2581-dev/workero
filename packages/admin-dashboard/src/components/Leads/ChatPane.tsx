  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed right-0 top-0 h-full w-full sm:w-96 lg:max-w-md bg-white shadow-large border-l border-gray-200 z-50 flex flex-col ${className}`}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-3 sm:p-4 border-b border-gray-200 bg-white">
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="font-semibold text-gray-900 text-sm sm:text-base truncate">{lead.client.name}</h3>
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  Send a message to {lead.client.name} to begin your conversation.
                </p>
              </div>
            </div>
          ) : (
