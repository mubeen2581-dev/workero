      ...
      <div className="space-y-6">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {quote.items.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="px-4 py-3 text-sm text-gray-900">{item.taxRate.toFixed(1)}%</td>
                    <td className="px-4 py-3 text-sm font-medium text-gray-900">{formatCurrency(item.lineTotal)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm text-gray-900">{formatCurrency(quote.taxAmount)}</span>
          </div>
          <div className="flex justify-between items-center pt-2 border-t border-gray-200">
            <span className="text-lg font-semibold text-gray-900">Total:</span>
            <span className="text-lg font-bold text-primary-600">{formatCurrency(quote.total)}</span>
          </div>
        </div>
