...
import { mockStockMovements, mockInventoryItems } from '@/mocks/inventory';
...
const StockMovementTracker: React.FC<StockMovementTrackerProps> = ({
  ...
  const filteredMovements = movements.filter(movement => {
    const matchesSearch = movement.item.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    const matchesItem = !itemFilter || movement.itemId === itemFilter;
