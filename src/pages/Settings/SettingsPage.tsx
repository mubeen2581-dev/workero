                ...
                {settingsTabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-2 sm:p-3 rounded-xl text-left transition-all duration-300 ${
                        isActive
                          ? 'bg-gradient-to-r from-purple-50 to-indigo-50 text-purple-700 shadow-sm border border-purple-100'
                          : 'text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 hover:text-purple-700 hover:shadow-sm'
                      }`}
                    >
                      <div className="flex items-center space-x-2 sm:space-x-3">
                        <Icon className={`w-4 h-4 sm:w-5 sm:h-5 ${isActive ? 'text-purple-600' : 'text-gray-500'}`} />
                        <div>
                      ...
                      <ChevronRight className={`w-3 h-3 sm:w-4 sm:h-4 ${isActive ? 'text-purple-600' : 'text-gray-400'}`} />
                    </button>
                  );
                })}
              </nav>
