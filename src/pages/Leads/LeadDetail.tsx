...
import AIAutoResponsePanel from '@/components/Leads/AIR.autoResponsePanel';
import FollowUpSettings from '@/components/Leads/FollowUpSettings';
import LeadActivities from '@/components/Leads/LeadActivities';
import EditLeadModal from '@/components/Leads/EditLeadModal';
import { useLead, useLeadActivities, useUpdateLead } from '@/services/leadQueries';
...
const LeadDetail: React.FC = () => {
  ...
  const lead = leadData ? {
    ...leadData,
    clientId: leadData.client_id || leadData.clientId,
    client: leadData.client,
    estimatedValue: leadData.estimated_value || leadData.estimatedValue,
    assignedTo: leadData.assigned_to || leadData.assignedTo,
    createdAt: leadData.created_at || leadData.createdAt,
    updatedAt: leadData.updated_at || leadData.updatedAt,
  } : null;
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <AIAutoResponsePanel onSave={(cfg) => console.log('save ai auto-response', cfg)} />

          {/* Follow-up Reminder Settings */}
          <FollowUpSettings onSave={(cfg) => console.log('save follow up', cfg)} />
        </motion.div>
        ...
        >
          ...
          <Card className="p-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">
                        {formatDistanceToNow(new Date(lead.updatedAt || lead.updated_at || ''), { addSuffix: true })}
                      </p>
                    </div>
                    <div>
            ...
            {activeTab === 'activity' && (
              <div className="-m-6">
                <LeadActivities activities={activities} isLoading={activitiesLoading} />
              </div>
            )}
