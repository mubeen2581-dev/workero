  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Recurring Billing</h2>
          <p className="text-sm sm:text-base text-gray-600">Manage automated recurring invoices</p>
        </div>
        
        <div className="flex items-center space-x-2 sm:space-x-3">
          <Button variant="secondary" size="sm" className="hidden sm:flex" icon={Download}>
            Export
          </Button>
          <Button variant="secondary" size="sm" className="sm:hidden p-2" icon={Download}>
          ...
          >
            <span className="hidden sm:inline">Create Recurring Billing</span>
